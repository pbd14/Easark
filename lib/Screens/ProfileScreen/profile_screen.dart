...
class _ProfileScreenState extends State<ProfileScreen> {
  bool loading = true;
  List<QueryDocumentSnapshot> favouritePlaces = [];
    ...
    await FirebaseFirestore.instance
      ...
      for (QueryDocumentSnapshot doc in value.docs) {
        if (user!.get('favourites') != null) {
          if (user!.get('favourites').contains(doc.id.toString())) {
            favouritePlaces.add(doc);
          }
        }
      }
      setState(() {
            ...
            SliverList(
              delegate: SliverChildListDelegate(
                [
                  ...
                  for (QueryDocumentSnapshot place in favouritePlaces)
                    Container(
